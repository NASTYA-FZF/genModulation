...
// genModulation.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CgenModulationApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CgenModulationApp

CgenModulationApp::CgenModulationApp()
{
...
// Единственный объект CgenModulationApp

CgenModulationApp theApp;


// Инициализация CgenModulationApp

BOOL CgenModulationApp::InitInstance()
{
